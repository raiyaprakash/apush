export default {
  async fetch(request) {
    const base = "https://fastrojgar2220.blogspot.com"; // Blogger website
    ...
    try {
      ...
      if (newResponseHeaders.get("location")) {
        ...
        newResponseHeaders.set(
          ...
          location
            ...
            .replace(base.replace("https://", ""), "www.fastrojgar.com")
        );
      }
      // ✅ Apply cache rules
      ...
      if (source.pathname === "/" || source.pathname === "") {
        ...
        // HTML pages → 7 days
        newResponseHeaders.set("Cache-Control", "public, s-maxage=604800, max-age=0");
