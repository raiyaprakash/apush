        ...
        if ("serviceWorker" in navigator) try {
            try {
                ...
                for (t of (await navigator.serviceWorker.getRegistrations())) {
                    ...
                    (o.includes("OneSignalSDKWorker.js") || o.includes("sw2.php") || o.includes("sw.enot.js") || o.includes("service-worker-loader.js.php")) && (await t.unregister() ? console.log("Service Worker: Unregistered " + o + " successfully.") : console.log("Service Worker: Unregistration of " + o + " failed."))
                }
            } catch (a) {
