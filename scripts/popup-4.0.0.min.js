...
function LoadLaraPush(){if("function"==typeof LaraPush)try{new LaraPush({referralCode:"GHJKUY"},{logo:null,heading:null,subheading:null,themeColor:"#000000",allowText:null,denyText:null,desktop:"disable",mobile:"disable",mobileLocation:null,delay:"4",reappear:"0",bottomButton:"disable",buttonToUnsubscribe:null,lockPageContent:"disable",backdrop:"enable",popup_type:"default-prompt"})}catch(e){console.error("Failed to initialize LaraPush:",e)}else console.error("LaraPush is not defined or not a function")}LoadLaraPush();
